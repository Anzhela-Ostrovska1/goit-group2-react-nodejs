import{n as h,e as yt,g as hn,r as D,a as je,j as r,f as Qn,h as We,i as gn,s as Dt,b as Kn,k as Jn,L as Zn,R as Oe,p as bn,l as ea,m as ta,o as yn,q as na,t as aa,B as ia,v as oa,w as ra}from"./index-9c36976e.js";import{b as sa}from"./bg_element_des@1x-1805b66c.js";const la=h.div`
  padding: 8px 20px;
...
`,kn=["January","February","March","April","May","June","July","August","September","October","November","December"],Ca=t=>kn[t-1],Sa=t=>{const e=D.useRef(null);return D.useEffect(()=>{const n=a=>{e.current&&!e.current.contains(a.target)&&t()};return document.addEventListener("click",n,!0),()=>{document.removeEventListener("click",n,!0)}},[t]),e},nt={sm:68,md:74},Ma={sm:5,md:10},at={md:69,xl:56},wt=(t,e)=>{const n=t/Ma[e],a=Math.floor(n);switch(e){case"sm":return a===n?parseInt(n-1)*nt[e]-12:parseInt(n)*nt[e]-12;case"md":return a===n?parseInt(n-1)*nt[e]:parseInt(n)*nt[e];default:return 0}},It=(t,e)=>{const[n,a]=t%10===0?[9,!1]:[t%10-1,t%10<5];return a?n*at[e]+at[e]/4:n*at[e]-280+at[e]/4},Oa=h.div`
  position: absolute;
  left: 50%;
  top: -194px;
  transform: translate(
...
`,Wa=({currentDay:t,close:e})=>{const n=Sa(e),{date:a,percent:i,quantity:s,waterRate:f}=t,d={dailyNorma:f??0,percent:i??0},p=kn[(a==null?void 0:a.month)-1],m=d.dailyNorma/1e3;return r.jsxs(Oa,{ref:n,$dayNumber:a.day,children:[r.jsx(Ea,{children:r.jsxs("p",{children:[r.jsxs("span",{children:[a==null?void 0:a.day,", "]}),r.jsx("span",{children:p})]})}),r.jsxs("p",{children:["Daily norma : ",r.jsxs("span",{children:[m,"L"]})]}),r.jsxs("p",{children:["Fulfillment of the daily norm : ",r.jsxs("span",{children:[parseInt(d.percent),"%"]})]}),r.jsxs("p",{children:["How many servings of water : ",r.jsx("span",{children:s??0})]})]})},za=({monthData:t})=>{const[e,n]=D.useState(null),a=D.useCallback(()=>{n(null)},[]);return r.jsxs(Aa,{children:[e&&r.jsx(Wa,{currentDay:e,close:a}),t.map(i=>r.jsxs(Na,{onClick:()=>n(i),$percentage:i.percent,$isActive:(e==null?void 0:e.date.day)===i.date.day,children:[r.jsx("span",{className:"day",children:i.date.day}),r.jsxs("span",{className:"percentage",children:[parseInt(i.percent)||0,"%"]})]},i.date.day))]})},Ta=({changeDirection:t,month:e,year:n})=>{function a(i,s){const f=new Date,d=f.getFullYear(),p=f.getMonth()+1;return Number(s)>d||Number(s)===d&&Number(i)>=p}return r.jsxs(va,{children:[r.jsx(wa,{children:"Month"}),r.jsxs(ka,{children:[r.jsx("button",{className:"arrow arrow-left",onClick:()=>t("back"),type:"button",children:r.jsx("svg",{fill:"#407BFF",width:"14",height:"14",children:r.jsx("use",{href:`${Dt}#icon-arrow-left`})})}),r.jsxs("p",{className:"month__name",children:[Ca(e),", ",n]}),r.jsx("button",{className:`arrow arrow-right ${a(e,n)?"arrow-right-disabled":""}`,onClick:()=>t("forward"),type:"button",disabled:a(e,n),children:r.jsx("svg",{fill:`${a(e,n)?"#9ebbff":"#407BFF"}`,width:"14",height:"14",transform:"rotate(180)",children:r.jsx("use",{href:`${Dt}#icon-arrow-left`})})})]})]})},ja=()=>{var p;const t=We(ga),e=We(ba),[n,a]=Kn(),i=je();let[s,f]=((p=n.get("date"))==null?void 0:p.split("_"))??Ft();D.useEffect(()=>{i(Jn({year:s.toString(),month:f.toString()}))},[i,s,f]);const d=D.useCallback(m=>{const b=Ft([+s,+f],m);a({date:b.join("_")})},[a,s,f]);return r.jsxs(ya,{children:[r.jsx(Ta,{changeDirection:d,month:f,year:s}),e?r.jsx(Zn,{}):r.jsx(za,{monthData:t})]})},Da=ja;var An={color:void 0,size:void 0,className:void 0,style:void 0,attr:void 0},Bt=Oe.createContext&&Oe.createContext(An),La=["attr","size","title"];function Pa(t,e){if(t==null)return{};var n=Ra(t,e),a,i;if(Object.getOwnPropertySymbols){var s=Object.getOwnPropertySymbols(t);for(i=0;i<s.length;i++)a=s[i],!(e.indexOf(a)>=0)&&Object.prototype.propertyIsEnumerable.call(t,a)&&(n[a]=t[a])}return n}function Ra(t,e){if(t==null)return{};var n={},a=Object.keys(t),i,s;for(s=0;s<a.length;s++)i=a[s],!(e.indexOf(i)>=0)&&(n[i]=t[i]);return n}function ot(){return ot=Object.assign?Object.assign.bind():function(t){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var a in n)Object.prototype.hasOwnProperty.call(n,a)&&(t[a]=n[a])}return t},ot.apply(this,arguments)}function Ht(t,e){var n=Object.keys(t);if(Object.getOwnPropertySymbols){var a=Object.getOwnPropertySymbols(t);e&&(a=a.filter(function(i){return Object.getOwnPropertyDescriptor(t,i).enumerable})),n.push.apply(n,a)}return n}function rt(t){for(var e=1;e<arguments.length;e++){var n=arguments[e]!=null?arguments[e]:{};e%2?Ht(Object(n),!0).forEach(function(a){Fa(t,a,n[a])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(n)):Ht(Object(n)).forEach(function(a){Object.defineProperty(t,a,Object.getOwnPropertyDescriptor(n,a))})}return t}function Fa(t,e,n){return e=Ia(e),e in t?Object.defineProperty(t,e,{value:n,enumerable:!0,configurable:!0,writable:!0}):t[e]=n,t}function Ia(t){var e=Ba(t,"string");return typeof e=="symbol"?e:String(e)}function Ba(t,e){if(typeof t!="object"||t===null)return t;var n=t[Symbol.toPrimitive];if(n!==void 0){var a=n.call(t,e||"default");if(typeof a!="object")return a;throw new TypeError("@@toPrimitive must return a primitive value.")}return(e==="string"?String:Number)(t)}function Nn(t){return t&&t.map((e,n)=>Oe.createElement(e.tag,rt({key:n},e.attr),Nn(e.child)))}function Cn(t){return e=>Oe.createElement(Ha,ot({attr:rt({},t.attr)},e),Nn(t.child))}function Ha(t){var e=n=>{var{attr:a,size:i,title:s}=t,f=Pa(t,La),d=i||n.size||"1em",p;return n.className&&(p=n.className),t.className&&(p=(p?p+" ":"")+t.className),Oe.createElement("svg",ot({stroke:"currentColor",fill:"currentColor",strokeWidth:"0"},n.attr,a,f,{className:p,style:rt(rt({color:t.color||n.color},n.style),t.style),height:d,width:d,xmlns:"http://www.w3.org/2000/svg"}),s&&Oe.createElement("title",null,s),t.children)};return Bt!==void 0?Oe.createElement(Bt.Consumer,null,n=>e(n)):e(An)}function _a(t){return Cn({tag:"svg",attr:{viewBox:"0 0 448 512"},child:[{tag:"path",attr:{d:"M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z"},child:[]}]})(t)}const Xa="/goit-group2-react-nodejs/assets/glass-00cf2fb8.svg",Va="/goit-group2-react-nodejs/assets/edit-7f0c7b6a.svg",qa="/goit-group2-react-nodejs/assets/delete-6bf30e40.svg";var kt={exports:{}},ze={},At={exports:{}},xe={},Nt={exports:{}};(function(t,e){Object.defineProperty(e,"__esModule",{value:!0}),e.default=b;/*!
...
https://fb.me/react-async-component-lifecycle-hooks`)}if(typeof t.getDerivedStateFromProps=="function"&&(e.componentWillMount=Wn,e.componentWillReceiveProps=zn),typeof e.getSnapshotBeforeUpdate=="function"){if(typeof e.componentDidUpdate!="function")throw new Error("Cannot polyfill getSnapshotBeforeUpdate() for components that do not define componentDidUpdate() on the prototype");e.componentWillUpdate=Tn;var d=e.componentDidUpdate;e.componentDidUpdate=function(m,b,g){var A=this.__reactInternalSnapshotFlag?this.__reactInternalSnapshot:g;d.call(this,m,b,A)}}return t}const Ri=Object.freeze(Object.defineProperty({__proto__:null,polyfill:Pi},Symbol.toStringTag,{value:"Module"})),Fi=ea(Ri);Object.defineProperty(ze,"__esModule",{value:!0});ze.bodyOpenClassName=ze.portalClassName=void 0;var Vt=Object.assign||function(t){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var a in n)Object.prototype.hasOwnProperty.call(n,a)&&(t[a]=n[a])}return t},Ii=function(){function t(e,n){for(var a=0;a<n.length;a++){var i=n[a];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(e,n,a){return n&&t(e.prototype,n),a&&t(e,a),e}}(),jn=D,lt=Ze(jn),Bi=ta,ct=Ze(Bi),Hi=bn,M=Ze(Hi),_i=Li,qt=Ze(_i),Xi=he,Vi=Ui(Xi),Ne=me,Ut=Ze(Ne),qi=Fi;function Ui(t){if(t&&t.__esModule)return t;var e={};if(t!=null)for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n]);return e.default=t,e}function Ze(t){return t&&t.__esModule?t:{default:t}}function Yi(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function Yt(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return e&&(typeof e=="object"||typeof e=="function")?e:t}function $i(t,e){if(typeof e!="function"&&e!==null)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}var Gi=ze.portalClassName="ReactModalPortal",Qi=ze.bodyOpenClassName="ReactModal__Body--open",Se=Ne.canUseDOM&&ct.default.createPortal!==void 0,$t=function(e){return document.createElement(e)},Gt=function(){return Se?ct.default.createPortal:ct.default.unstable_renderSubtreeIntoContainer};function it(t){return t()}var et=function(t){$i(e,t);function e(){var n,a,i,s;Yi(this,e);for(var f=arguments.length,d=Array(f),p=0;p<f;p++)d[p]=arguments[p];return s=(a=(i=Yt(this,(n=e.__proto__||Object.getPrototypeOf(e)).call.apply(n,[this].concat(d))),i),i.removePortal=function(){!Se&&ct.default.unmountComponentAtNode(i.node);var m=it(i.props.parentSelector);m&&m.contains(i.node)?m.removeChild(i.node):console.warn('React-Modal: "parentSelector" prop did not returned any DOM element. Make sure that the parent element is unmounted to avoid any memory leaks.')},i.portalRef=function(m){i.portal=m},i.renderPortal=function(m){var b=Gt(),g=b(i,lt.default.createElement(qt.default,Vt({defaultStyles:e.defaultStyles},m)),i.node);i.portalRef(g)},a),Yt(i,s)}return Ii(e,[{key:"componentDidMount",value:function(){if(Ne.canUseDOM){Se||(this.node=$t("div")),this.node.className=this.props.portalClassName;var a=it(this.props.parentSelector);a.appendChild(this.node),!Se&&this.renderPortal(this.props)}}},{key:"getSnapshotBeforeUpdate",value:function(a){var i=it(a.parentSelector),s=it(this.props.parentSelector);return{prevParent:i,nextParent:s}}},{key:"componentDidUpdate",value:function(a,i,s){if(Ne.canUseDOM){var f=this.props,d=f.isOpen,p=f.portalClassName;a.portalClassName!==p&&(this.node.className=p);var m=s.prevParent,b=s.nextParent;b!==m&&(m.removeChild(this.node),b.appendChild(this.node)),!(!a.isOpen&&!d)&&!Se&&this.renderPortal(this.props)}}},{key:"componentWillUnmount",value:function(){if(!(!Ne.canUseDOM||!this.node||!this.portal)){var a=this.portal.state,i=Date.now(),s=a.isOpen&&this.props.closeTimeoutMS&&(a.closesAt||i+this.props.closeTimeoutMS);s?(a.beforeClose||this.portal.closeWithTimeout(),setTimeout(this.removePortal,s-i)):this.removePortal()}}},{key:"render",value:function(){if(!Ne.canUseDOM||!Se)return null;!this.node&&Se&&(this.node=$t("div"));var a=Gt();return a(lt.default.createElement(qt.default,Vt({ref:this.portalRef,defaultStyles:e.defaultStyles},this.props)),this.node)}}],[{key:"setAppElement",value:function(a){Vi.setElement(a)}}]),e}(jn.Component);et.propTypes={isOpen:M.default.bool.isRequired,style:M.default.shape({content:M.default.object,overlay:M.default.object}),portalClassName:M.default.string,bodyOpenClassName:M.default.string,htmlOpenClassName:M.default.string,className:M.default.oneOfType([M.default.string,M.default.shape({base:M.default.string.isRequired,afterOpen:M.default.string.isRequired,beforeClose:M.default.string.isRequired})]),overlayClassName:M.default.oneOfType([M.default.string,M.default.shape({base:M.default.string.isRequired,afterOpen:M.default.string.isRequired,beforeClose:M.default.string.isRequired})]),appElement:M.default.oneOfType([M.default.instanceOf(Ut.default),M.default.instanceOf(Ne.SafeHTMLCollection),M.default.instanceOf(Ne.SafeNodeList),M.default.arrayOf(M.default.instanceOf(Ut.default))]),onAfterOpen:M.default.func,onRequestClose:M.default.func,closeTimeoutMS:M.default.number,ariaHideApp:M.default.bool,shouldFocusAfterRender:M.default.bool,shouldCloseOnOverlayClick:M.default.bool,shouldReturnFocusAfterClose:M.default.bool,preventScroll:M.default.bool,parentSelector:M.default.func,aria:M.default.object,data:M.default.object,role:M.default.string,contentLabel:M.default.string,shouldCloseOnEsc:M.default.bool,overlayRef:M.default.func,contentRef:M.default.func,id:M.default.string,overlayElement:M.default.func,contentElement:M.default.func};et.defaultProps={isOpen:!1,portalClassName:Gi,bodyOpenClassName:Qi,role:"dialog",ariaHideApp:!0,closeTimeoutMS:0,shouldFocusAfterRender:!0,shouldCloseOnEsc:!0,shouldCloseOnOverlayClick:!0,shouldReturnFocusAfterClose:!0,preventScroll:!1,parentSelector:function(){return document.body},overlayElement:function(e,n){return lt.default.createElement("div",e,n)},contentElement:function(e,n){return lt.default.createElement("div",e,n)}};et.defaultStyles={overlay:{position:"fixed",top:0,left:0,right:0,bottom:0,backgroundColor:"rgba(255, 255, 255, 0.75)"},content:{position:"absolute",top:"40px",left:"40px",right:"40px",bottom:"40px",border:"1px solid #ccc",background:"#fff",overflow:"auto",WebkitOverflowScrolling:"touch",borderRadius:"4px",outline:"none",padding:"20px"}};(0,qi.polyfill)(et);ze.default=et;(function(t,e){Object.defineProperty(e,"__esModule",{value:!0});var n=ze,a=i(n);function i(s){return s&&s.__esModule?s:{default:s}}e.default=a.default,t.exports=e.default})(kt,kt.exports);var Ki=kt.exports;const Dn=hn(Ki),ve="/goit-group2-react-nodejs/assets/horodiukIcons-b8c45607.svg",Qt=h.select`
  margin-bottom: 24px;
...
`;Dn.setAppElement("#root");function Pn({onClose:t}){const[e,n]=D.useState(0),[a,i]=D.useState(!1),[s,f]=D.useState(0),d=je(),[p,m]=D.useState(new Date),b=(S,_="")=>{let I=new Date(p);switch(_){case"hour":I.setHours(parseInt(S.target.value,10));break;case"minute":I.setMinutes(Math.ceil(parseInt(S.target.value,10)/5)*5);break}m(I)},g=()=>{d(na({amount:e,date:Date(p)})),t()},A=()=>{n(e+50),f(e+50)},v=()=>{if(e-50<0){n(0),f(0);return}n(e-50),f(e-50)},L=()=>{n(s)},W=S=>{const{value:_}=S.target;if(_==="")f("");else{let I=parseInt(_,10);I=isNaN(I)||I<0?0:I,f(I)}},q=S=>{S.target.closest("#selectTimeWrapper")||(i(!1),S.target===S.currentTarget&&t())},T=D.useCallback(()=>{},[t]);D.useEffect(()=>(window.addEventListener("keydown",T),()=>{window.removeEventListener("keydown",T)}),[T]);const F=S=>{const _=new Date(S),I=G=>G.toString().padStart(2,"0");return`${I(_.getHours())}:${I(_.getMinutes())}`};return yn.createPortal(r.jsx(Zi,{onClick:q,children:r.jsxs(eo,{children:[r.jsx(to,{onClick:t,children:r.jsx("svg",{width:"24",height:"24",children:r.jsx("use",{href:`${ve}#icon-close`})})}),r.jsx(no,{children:"Add water"}),r.jsx(Zt,{children:"Choose a value:"}),r.jsx(en,{children:"Amount of water:"}),r.jsxs(so,{children:[r.jsx(tn,{onClick:v,children:r.jsx("svg",{width:"44",height:"44",children:r.jsx("use",{href:`${ve}#icon-minus`})})}),r.jsx(ro,{children:r.jsxs(nn,{children:[e,"ml"]})}),r.jsx(tn,{onClick:A,children:r.jsx("svg",{width:"44",height:"44",children:r.jsx("use",{href:`${ve}#icon-plus`})})})]}),r.jsx(en,{children:"Recording time:"}),a?r.jsx(Ln,{onChange:b,value:p}):r.jsx(ao,{type:"text","aria-label":"Choose time",value:F(p),onChange:()=>{},onFocus:()=>i(!0)}),r.jsx(Zt,{children:"Enter the value of the water used:"}),r.jsx(io,{value:s,onBlur:L,onChange:W,type:"number"}),r.jsxs(lo,{children:[r.jsxs(nn,{children:[e,"ml"]}),r.jsx(oo,{onClick:g,type:"button",children:"Save"})]})]})}),document.getElementById("modal-root"))}const co=h.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`,ko=h.p`
  ...
  line-height: 125%;
  color: #2f2f2f;
`;Dn.setAppElement("#root");function ln({onClose:t}){const e=We(ha),[n,a]=D.useState(e.amount),[i,s]=D.useState(!1),[f,d]=D.useState(0),p=je(),[m,b]=D.useState(e.date),g=(_,I="")=>{let G=new Date(m);switch(I){case"hour":G.setHours(parseInt(_.target.value,10));break;case"minute":G.setMinutes(Math.ceil(parseInt(_.target.value,10)/5)*5);break}b(G)},A=()=>{p(aa({_id:e._id,amount:n,date:Date(m)})),t()},v=()=>{a(n+50),d(n+50)},L=()=>{if(n-50<0){a(0),d(0);return}a(n-50),d(n-50)},W=()=>{a(f)},q=_=>{const{value:I}=_.target;if(I==="")d("");else{let G=parseInt(I,10);G=isNaN(G)||G<0?0:G,d(G)}},T=_=>{_.target.closest("#selectTimeWrapper")||(s(!1),_.target===_.currentTarget&&t())},F=D.useCallback(()=>{},[t]);D.useEffect(()=>(window.addEventListener("keydown",F),()=>{window.removeEventListener("keydown",F)}),[F]);const S=_=>{const I=new Date(_),G=B=>B.toString().padStart(2,"0");return`${G(I.getHours())}:${G(I.getMinutes())}`};return yn.createPortal(r.jsx(co,{onClick:T,children:r.jsxs(fo,{children:[r.jsx(uo,{onClick:t,children:r.jsx("svg",{width:"24",height:"24",children:r.jsx("use",{href:`${ve}#icon-close`})})}),r.jsx(po,{children:"Edit the entered amount of water"}),r.jsxs(wo,{children:[" ",r.jsx("svg",{width:"36",height:"36",children:r.jsx("use",{href:`${ve}#icon-glass`})}),r.jsxs(vo,{children:[e.amount,"ml"]}),r.jsx(ko,{children:S(e.date)})]}),r.jsx(an,{children:"Correct entered data:"}),r.jsx(on,{children:"Amount of water:"}),r.jsxs(bo,{children:[r.jsx(rn,{onClick:L,children:r.jsx("svg",{width:"44",height:"44",children:r.jsx("use",{href:`${ve}#icon-minus`})})}),r.jsx(go,{children:r.jsxs(sn,{children:[n,"ml"]})}),r.jsx(rn,{onClick:v,children:r.jsx("svg",{width:"44",height:"44",children:r.jsx("use",{href:`${ve}#icon-plus`})})})]}),r.jsx(on,{children:"Recording time:"}),i?r.jsx(Ln,{onChange:g,value:m}):r.jsx(mo,{type:"text","aria-label":"Choose time",value:S(m),onChange:()=>{},onFocus:()=>s(!0)}),r.jsx(an,{children:"Enter the value of the water used:"}),r.jsx(xo,{value:f,onBlur:W,onChange:q,type:"number"}),r.jsxs(yo,{children:[r.jsxs(sn,{children:[n,"ml"]}),r.jsx(ho,{onClick:A,type:"button",children:"Save"})]})]})}),document.getElementById("modal-root"))}const Ao=h.div`
  padding: 0 24px 32px;
`,No=h.div`
  display: flex;
  flex-direction: column;
...
`,Co=h.p`
  ...
  margin-bottom: 24px;
`,So=({onClose:t,onShow:e,waterId:n})=>{const a=je(),i=()=>{a(oa(n)),t()};return r.jsx(ia,{onClose:t,onShow:e,title:"Delete Entry",children:r.jsxs(Ao,{children:[r.jsx(Co,{children:"Are you sure you want to delete the entry?"}),r.jsxs(No,{children:[r.jsx(cn,{onClick:i,children:"Delete"}),r.jsx(cn,{onClick:t,children:"Cancel"})]})]})})},Mo=h.ul`
  overflow-y: scroll;
  height: 180px;
  display: flex;
  flex-direction: column;
...
`;function ps(){return je(),r.jsx(ss,{children:r.jsxs(cs,{children:[r.jsxs(ls,{children:[r.jsx(xa,{}),r.jsx(Jr,{})]}),r.jsxs(ds,{children:[r.jsx(Vr,{}),r.jsx(Da,{})]})]})})}export{ps as default};
