import{n as d,j as a,R as X,r as j,g as xt,a as vt,b as bt,c as Xe,d as yt,e as Ke,f as wt}from"./index-e635bf7d.js";import{u as Ge}from"./useDispatch-4142be59.js";import{b as Ot}from"./bg_element_des@1x-1805b66c.js";const Ct=d.div`
  padding: 8px 20px;
...
`,Fe=d.svg`
  ...
  right: 6px;
  pointer-events: none;
`;function pt({onChange:e,value:t}){const n=Array.from(new Array(24),(c,p)=>p),o=[0,5,10,15,20,25,30,35,40,45,50,55],i=new Date(t);let l=i.getHours(),x=i.getMinutes();const s=o.reduce((c,p)=>p>=x&&(c===null||Math.abs(p-x)<Math.abs(c-x))?p:c,null);return s===null?(l=(l+1)%24,x=0):x=s,a.jsxs(Qn,{id:"selectTimeWrapper",children:[a.jsxs(We,{children:[a.jsx(De,{onChange:c=>e(c,"hour"),value:l,children:n.map(c=>a.jsx("option",{value:c,children:c.toString().padStart(2,"0")},c))}),a.jsx(Fe,{width:"24",height:"24",children:a.jsx("use",{href:`${H}#icon-arrow`})})]}),":",a.jsxs(We,{children:[a.jsx(De,{onChange:c=>e(c,"minute"),value:x,children:o.map(c=>a.jsx("option",{value:c,children:c.toString().padStart(2,"0")},c))}),a.jsx(Fe,{width:"24",height:"24",children:a.jsx("use",{href:`${H}#icon-arrow`})})]})]})}const Zn=d.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`;ut.setAppElement("#root");function ft({isOpen:e,onClose:t,onAddWater:n}){const[o,i]=j.useState(0),[l,x]=j.useState(!1),[s,c]=j.useState(0),p=Ge(),[v,h]=j.useState(new Date),A=(C,w="")=>{let P=new Date(v);switch(w){case"hour":P.setHours(parseInt(C.target.value,10));break;case"minute":P.setMinutes(Math.ceil(parseInt(C.target.value,10)/5)*5);break}h(P)},b=()=>{p(yt({amount:o,date:Date(v)}))},y=()=>{t()},T=()=>{i(o+50),c(o+50)},L=()=>{if(o-50<0){i(0),c(0);return}i(o-50),c(o-50)},F=()=>{i(s)},te=C=>{const w=parseInt(C.target.value>0?C.target.value:0,10);c(w)},Y=C=>{C.target.closest("#selectTimeWrapper")||(x(!1),C.target===C.currentTarget&&y())},U=C=>{C.key==="Escape"&&y()};j.useEffect(()=>(window.addEventListener("keydown",U),()=>{window.removeEventListener("keydown",U)}),[]);const I=C=>{const w=new Date(C),P=_=>_.toString().padStart(2,"0");return`${P(w.getHours())}:${P(w.getMinutes())}`};return Xe.createPortal(a.jsx(Zn,{onClick:Y,children:a.jsxs(eo,{children:[a.jsx(to,{onClick:y,children:a.jsx("svg",{width:"24",height:"24",children:a.jsx("use",{href:`${H}#icon-close`})})}),a.jsx(no,{children:"Add water"}),a.jsx(Le,{children:"Choose a value:"}),a.jsx(Ie,{children:"Amount of water:"}),a.jsxs(so,{children:[a.jsx(He,{onClick:L,children:a.jsx("svg",{width:"44",height:"44",children:a.jsx("use",{href:`${H}#icon-minus`})})}),a.jsx(io,{children:a.jsxs(Ue,{children:[o,"ml"]})}),a.jsx(He,{onClick:T,children:a.jsx("svg",{width:"44",height:"44",children:a.jsx("use",{href:`${H}#icon-plus`})})})]}),a.jsx(Ie,{children:"Recording time:"}),l?a.jsx(pt,{onChange:A,value:v}):a.jsx(oo,{type:"text","aria-label":"Choose time",value:I(v),onChange:()=>{},onFocus:()=>x(!0)}),a.jsx(Le,{children:"Enter the value of the water used:"}),a.jsx(ro,{value:s,onBlur:F,onChange:te,type:"number"}),a.jsxs(lo,{children:[a.jsxs(Ue,{children:[o,"ml"]}),a.jsx(ao,{onClick:b,type:"button",children:"Save"})]})]})}),document.getElementById("modal-root"))}const co=d.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`,wo=d.p`
  ...
  line-height: 125%;
  color: #2f2f2f;
`;ut.setAppElement("#root");function Oo({isOpen:e,onClose:t,onAddWater:n}){const o=Ke(Wt)||{amount:250,date:new Date},[i,l]=j.useState(o.amount),[x,s]=j.useState(!1),[c,p]=j.useState(0),v=Ge(),[h,A]=j.useState(o.date),b=(w,P="")=>{let _=new Date(h);switch(P){case"hour":_.setHours(parseInt(w.target.value,10));break;case"minute":_.setMinutes(Math.ceil(parseInt(w.target.value,10)/5)*5);break}A(_)},y=()=>{v(wt({amount:i,date:Date(h)}))},T=()=>{t()},L=()=>{l(i+50),p(i+50)},F=()=>{if(i-50<0){l(0),p(0);return}l(i-50),p(i-50)},te=()=>{l(c)},Y=w=>{const P=parseInt(w.target.value>0?w.target.value:0,10);p(P)},U=w=>{w.target.closest("#selectTimeWrapper")||(s(!1),w.target===w.currentTarget&&T())},I=w=>{w.key==="Escape"&&T()};j.useEffect(()=>(window.addEventListener("keydown",I),()=>{window.removeEventListener("keydown",I)}),[]);const C=w=>{const P=new Date(w),_=Ae=>Ae.toString().padStart(2,"0");return`${_(P.getHours())}:${_(P.getMinutes())}`};return Xe.createPortal(a.jsx(co,{onClick:U,children:a.jsxs(uo,{children:[a.jsx(po,{onClick:T,children:a.jsx("svg",{width:"24",height:"24",children:a.jsx("use",{href:`${H}#icon-close`})})}),a.jsx(fo,{children:"Edit the entered amount of water"}),a.jsxs(bo,{children:[" ",a.jsx("svg",{width:"36",height:"36",children:a.jsx("use",{href:`${H}#icon-glass`})}),a.jsxs(yo,{children:[o.amount,"ml"]}),a.jsx(wo,{children:C(o.time)})]}),a.jsx(ze,{children:"Correct entered data:"}),a.jsx(Be,{children:"Amount of water:"}),a.jsxs(xo,{children:[a.jsx(qe,{onClick:F,children:a.jsx("svg",{width:"44",height:"44",children:a.jsx("use",{href:`${H}#icon-minus`})})}),a.jsx(Ao,{children:a.jsxs($e,{children:[i,"ml"]})}),a.jsx(qe,{onClick:L,children:a.jsx("svg",{width:"44",height:"44",children:a.jsx("use",{href:`${H}#icon-plus`})})})]}),a.jsx(Be,{children:"Recording time:"}),x?a.jsx(pt,{onChange:b,value:h}):a.jsx(ho,{type:"text","aria-label":"Choose time",value:C(h),onChange:()=>{},onFocus:()=>s(!0)}),a.jsx(ze,{children:"Enter the value of the water used:"}),a.jsx(mo,{value:c,onBlur:te,onChange:Y,type:"number"}),a.jsxs(vo,{children:[a.jsxs($e,{children:[i,"ml"]}),a.jsx(go,{onClick:y,type:"button",children:"Save"})]})]})}),document.getElementById("modal-root"))}const Co=d.ul`
  overflow-y: scroll;
  height: 180px;
  display: flex;
  flex-direction: column;
...
`,ko=[{id:"1",amount:"250ml",time:"14:00 PM"},{id:"2",amount:"250ml",time:"14:00 PM"},{id:"3",amount:"250ml",time:"14:00 PM"},{id:"4",amount:"250ml",time:"14:00 PM"},{id:"5",amount:"250ml",time:"14:00 PM"},{id:"6",amount:"250ml",time:"14:00 PM"}],_o=()=>{const[e,t]=j.useState(ko),[n,o]=j.useState(!1),[i,l]=j.useState(!1),x=Ke(Dt);console.log(x);const s=()=>{o(!1)},c=()=>{o(!0)},p=()=>{l(!1)},v=()=>{l(!0)},h=A=>{t(b=>b.filter(y=>y.id!==A))};return a.jsxs("div",{children:[a.jsxs("div",{children:[a.jsx(Po,{children:"Today"}),a.jsx(Co,{children:e.length>0&&e.map(({id:A,amount:b,time:y})=>a.jsxs(a.Fragment,{children:[" ",a.jsxs(Eo,{children:[a.jsxs(So,{children:[a.jsx("img",{src:Ft,alt:"Icon glass"}),a.jsx(Mo,{children:b}),a.jsx(jo,{children:y})]}),a.jsxs("div",{children:[a.jsx("button",{type:"button",onClick:v,children:a.jsx("img",{src:Lt,alt:"Icon glass"})}),a.jsx("button",{type:"button",onClick:()=>h(A),children:a.jsx("img",{src:It,alt:"Icon glass"})})]})]},A),i&&a.jsx(Oo,{isOpen:i,onClose:p})]}))})]}),a.jsxs(To,{type:"button",onClick:c,children:[a.jsx(Vt,{})," Add Water"]}),n&&a.jsx(ft,{isOpen:n,onClose:s})]})},No=_o;function Ro(e){return Qe({tag:"svg",attr:{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},child:[{tag:"circle",attr:{cx:"12",cy:"12",r:"10"},child:[]},{tag:"line",attr:{x1:"12",y1:"8",x2:"12",y2:"16"},child:[]},{tag:"line",attr:{x1:"8",y1:"12",x2:"16",y2:"12"},child:[]}]})(e)}const Vo=d.div`
  display: flex;
  justify-content: center;
  align-items: center;
  flex-direction: column;
...
`;function or(){return a.jsx(Yo,{children:a.jsxs(Qo,{children:[a.jsxs(Jo,{children:[a.jsx(Mt,{}),a.jsx(Ho,{})]}),a.jsx(Zo,{children:a.jsx(No,{})})]})})}export{or as default};
