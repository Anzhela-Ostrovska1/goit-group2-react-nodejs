import{n as f,r as w,p as Ct,g as Zt,e as en,f as tn,a as re,R as Ie,j as a,N as Ue,h as nn,i as xe,k as X,l as Et,s as Xe,b as rn,L as on,m as Z,o as an,q as sn,B as cn,t as ln,v as jt,w as dn}from"./index-12d2f60a.js";import{b as un}from"./bg_element_des@1x-1805b66c.js";const fn=f.div`
  padding: 8px 20px;
...
`,xt=f.svg`
  ...
  right: 6px;
  pointer-events: none;
`;function Yt({onChange:e,value:t}){const n=Array.from(new Array(24),(d,u)=>u),r=[0,5,10,15,20,25,30,35,40,45,50,55],o=new Date(t);let s=o.getHours(),l=o.getMinutes();const i=r.reduce((d,u)=>u>=l&&(d===null||Math.abs(u-l)<Math.abs(d-l))?u:d,null);return i===null?(s=(s+1)%24,l=0):l=i,a.jsxs(ia,{id:"selectTimeWrapper",children:[a.jsxs(gt,{children:[a.jsx(mt,{onChange:d=>e(d,"hour"),value:s,children:n.map(d=>a.jsx("option",{value:d,children:d.toString().padStart(2,"0")},d))}),a.jsx(xt,{width:"24",height:"24",children:a.jsx("use",{href:`${z}#icon-arrow`})})]}),":",a.jsxs(gt,{children:[a.jsx(mt,{onChange:d=>e(d,"minute"),value:l,children:r.map(d=>a.jsx("option",{value:d,children:d.toString().padStart(2,"0")},d))}),a.jsx(xt,{width:"24",height:"24",children:a.jsx("use",{href:`${z}#icon-arrow`})})]})]})}const sa=f.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`;ze.setAppElement("#root");function Ut({onClose:e}){const[t,n]=w.useState(0),[r,o]=w.useState(!1),[s,l]=w.useState(0),i=re(),[d,u]=w.useState(new Date),{year:h,month:p}=Ne(),g=(T,E="")=>{let k=new Date(d);switch(E){case"hour":k.setHours(parseInt(T.target.value,10));break;case"minute":k.setMinutes(Math.ceil(parseInt(T.target.value,10)/5)*5);break}u(k)},y=()=>{i(an({amount:t,date:Date(d)})),i(xe({year:h,month:p})),e()},M=()=>{n(t+50),l(t+50)},P=()=>{if(t-50<0){n(0),l(0);return}n(t-50),l(t-50)},C=()=>{n(s)},D=T=>{const{value:E}=T.target;if(E==="")l("");else{let k=parseInt(E,10);k=isNaN(k)||k<0?0:k,l(k)}},S=T=>{T.target.closest("#selectTimeWrapper")||(o(!1),T.target===T.currentTarget&&e())},A=w.useCallback(()=>{},[e]);w.useEffect(()=>(window.addEventListener("keydown",A),()=>{window.removeEventListener("keydown",A)}),[A]);const W=T=>{const E=new Date(T),k=_=>_.toString().padStart(2,"0");return`${k(E.getHours())}:${k(E.getMinutes())}`};return Ie.createPortal(a.jsx(sa,{onClick:S,children:a.jsxs(ca,{children:[a.jsx(la,{onClick:e,children:a.jsx(da,{width:"24",height:"24",children:a.jsx("use",{href:`${z}#icon-close`})})}),a.jsx(ua,{children:"Add water"}),a.jsx(bt,{children:"Choose a value:"}),a.jsx(vt,{children:"Amount of water:"}),a.jsxs(ga,{children:[a.jsx(yt,{onClick:P,children:a.jsx("svg",{width:"44",height:"44",children:a.jsx("use",{href:`${z}#icon-minus`})})}),a.jsx(ma,{children:a.jsxs(wt,{children:[t,"ml"]})}),a.jsx(yt,{onClick:M,children:a.jsx("svg",{width:"44",height:"44",children:a.jsx("use",{href:`${z}#icon-plus`})})})]}),a.jsx(vt,{children:"Recording time:"}),r?a.jsx(Yt,{onChange:g,value:d}):a.jsx(fa,{type:"text","aria-label":"Choose time",value:W(d),onChange:()=>{},onFocus:()=>o(!0)}),a.jsx(bt,{children:"Enter the value of the water used:"}),a.jsx(pa,{value:s,onBlur:C,onChange:D,type:"number"}),a.jsxs(xa,{children:[a.jsxs(wt,{children:[t,"ml"]}),a.jsx(ha,{onClick:y,type:"button",children:"Save"})]})]})}),document.getElementById("modal-root"))}const ba=f.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`,Pa=f.p`
  ...
  line-height: 125%;
  color: #2f2f2f;
`;ze.setAppElement("#root");function Da({onClose:e}){const t=X(No),[n,r]=w.useState(t.amount),[o,s]=w.useState(!1),[l,i]=w.useState(0),d=re(),[u,h]=w.useState(t.date),{year:p,month:g}=Ne(),y=(E,k="")=>{let _=new Date(u);switch(k){case"hour":_.setHours(parseInt(E.target.value,10));break;case"minute":_.setMinutes(Math.ceil(parseInt(E.target.value,10)/5)*5);break}h(_)},M=()=>{d(sn({_id:t.id,amount:n,date:new Date(u)})),d(xe({year:p,month:g})),e()},P=()=>{r(n+50),i(n+50)},C=()=>{if(n-50<0){r(0),i(0);return}r(n-50),i(n-50)},D=()=>{r(l)},S=E=>{const{value:k}=E.target;if(k==="")i("");else{let _=parseInt(k,10);_=isNaN(_)||_<0?0:_,i(_)}},A=E=>{E.target.closest("#selectTimeWrapper")||(s(!1),E.target===E.currentTarget&&e())},W=w.useCallback(()=>{},[e]);w.useEffect(()=>(window.addEventListener("keydown",W),()=>{window.removeEventListener("keydown",W)}),[W]);const T=E=>{const k=new Date(E),_=le=>le.toString().padStart(2,"0");return`${_(k.getHours())}:${_(k.getMinutes())}`};return Ie.createPortal(a.jsx(ba,{onClick:A,children:a.jsxs(va,{children:[a.jsx(ya,{onClick:e,children:a.jsx("svg",{width:"24",height:"24",children:a.jsx("use",{href:`${z}#icon-close`})})}),a.jsx(wa,{children:"Edit the entered amount of water"}),a.jsxs(Ea,{children:[" ",a.jsx("svg",{width:"36",height:"36",children:a.jsx("use",{href:`${z}#icon-glass`})}),a.jsxs(ja,{children:[t.amount,"ml"]}),a.jsx(Pa,{children:T(t.date)})]}),a.jsx(At,{children:"Correct entered data:"}),a.jsx(Ot,{children:"Amount of water:"}),a.jsxs(ka,{children:[a.jsx(Mt,{onClick:C,children:a.jsx("svg",{width:"44",height:"44",children:a.jsx("use",{href:`${z}#icon-minus`})})}),a.jsx(Sa,{children:a.jsxs(St,{children:[n,"ml"]})}),a.jsx(Mt,{onClick:P,children:a.jsx("svg",{width:"44",height:"44",children:a.jsx("use",{href:`${z}#icon-plus`})})})]}),a.jsx(Ot,{children:"Recording time:"}),o?a.jsx(Yt,{onChange:y,value:u}):a.jsx(Aa,{type:"text","aria-label":"Choose time",value:T(u),onChange:()=>{},onFocus:()=>s(!0)}),a.jsx(At,{children:"Enter the value of the water used:"}),a.jsx(Oa,{value:l,onBlur:D,onChange:S,type:"number"}),a.jsxs(Ca,{children:[a.jsxs(St,{children:[n,"ml"]}),a.jsx(Ma,{onClick:M,type:"button",children:"Save"})]})]})}),document.getElementById("modal-root"))}const Ta=f.div`
  padding: 0 24px 32px;
`,Na=f.div`
  display: flex;
  flex-direction: column;
...
`,Wa=f.p`
  ...
  margin-bottom: 24px;
`,_a=({onClose:e,isShow:t,id:n})=>{const r=re(),{year:o,month:s}=Ne();console.log("id в DeleteEntryModal який прийшов з пропсів",n);const l=i=>{console.log("id в DeleteEntryModal - handleDelete",i),r(ln(i)),r(xe({year:o,month:s})),r(jt()),e()};return a.jsx(cn,{onClose:e,isShow:t,title:"Delete Entry",children:a.jsxs(Ta,{children:[a.jsx(Wa,{children:"Are you sure you want to delete the entry?"}),a.jsxs(Na,{children:[a.jsx(kt,{onClick:()=>l(n),children:"Delete"}),a.jsx(kt,{onClick:e,style:{color:"#407BFF"},children:"Cancel"})]})]})})},Fa=f.ul`
  overflow-y: scroll;
  height: 180px;
  display: flex;
  flex-direction: column;
