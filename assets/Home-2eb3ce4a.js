import{n as f,r as A,p as Et,g as en,e as tn,f as nn,a as re,R as Ie,j as a,N as Ue,h as rn,i as xe,k as X,l as jt,s as Xe,b as on,L as an,m as Z,o as sn,q as cn,B as ln,t as dn,v as Pt,w as un}from"./index-746282c6.js";import{b as fn}from"./bg_element_des@1x-1805b66c.js";const pn=f.div`
  padding: 8px 20px;
...
`,qt=["January","February","March","April","May","June","July","August","September","October","November","December"],qo=e=>qt[e-1],zo=e=>{const t=A.useRef(null);return A.useEffect(()=>{const n=r=>{t.current&&!t.current.contains(r.target)&&e()};return document.addEventListener("click",n,!0),()=>{document.removeEventListener("click",n,!0)}},[e]),t},Oe={sm:68,md:74},Yo={sm:5,md:10},Me={md:69,xl:56},Fe=(e,t)=>{const n=e/Yo[t],r=Math.floor(n);switch(t){case"sm":return r===n?parseInt(n-1)*Oe[t]-12:parseInt(n)*Oe[t]-12;case"md":return r===n?parseInt(n-1)*Oe[t]:parseInt(n)*Oe[t];default:return 0}},ft=(e,t)=>{const[n,r]=e%10===0?[9,!1]:[e%10-1,e%10<5];return r?n*Me[t]+Me[t]/4:n*Me[t]-280+Me[t]/4},$o=f.div`
  position: absolute;
  left: 50%;
  top: -194px;
  transform: translate(
...
`,xt=f.svg`
  ...
  right: 6px;
  pointer-events: none;
`;function Ut({onChange:e,value:t}){const n=Array.from(new Array(24),(d,u)=>u),r=[0,5,10,15,20,25,30,35,40,45,50,55],o=new Date(t);let s=o.getHours(),l=o.getMinutes();const i=r.reduce((d,u)=>u>=l&&(d===null||Math.abs(u-l)<Math.abs(d-l))?u:d,null);return i===null?(s=(s+1)%24,l=0):l=i,a.jsxs(da,{id:"selectTimeWrapper",children:[a.jsxs(gt,{children:[a.jsx(mt,{onChange:d=>e(d,"hour"),value:s,children:n.map(d=>a.jsx("option",{value:d,children:d.toString().padStart(2,"0")},d))}),a.jsx(xt,{width:"24",height:"24",children:a.jsx("use",{href:`${Y}#icon-arrow`})})]}),":",a.jsxs(gt,{children:[a.jsx(mt,{onChange:d=>e(d,"minute"),value:l,children:r.map(d=>a.jsx("option",{value:d,children:d.toString().padStart(2,"0")},d))}),a.jsx(xt,{width:"24",height:"24",children:a.jsx("use",{href:`${Y}#icon-arrow`})})]})]})}const ua=f.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`;Ye.setAppElement("#root");function Xt({onClose:e}){const[t,n]=A.useState(0),[r,o]=A.useState(!1),[s,l]=A.useState(0),i=re(),[d,u]=A.useState(new Date),{year:h,month:p}=Ne(),g=(D,E="")=>{let C=new Date(d);switch(E){case"hour":C.setHours(parseInt(D.target.value,10));break;case"minute":C.setMinutes(Math.ceil(parseInt(D.target.value,10)/5)*5);break}u(C)},y=()=>{i(sn({amount:t,date:Date(d)})),i(xe({year:h,month:p})),e()},O=()=>{n(t+50),l(t+50)},S=()=>{if(t-50<0){n(0),l(0);return}n(t-50),l(t-50)},P=()=>{n(s)},V=D=>{const{value:E}=D.target;if(E==="")l("");else{let C=parseInt(E,10);C=isNaN(C)||C<0?0:C,l(C)}},k=D=>{D.target.closest("#selectTimeWrapper")||(o(!1),D.target===D.currentTarget&&e())},w=A.useCallback(()=>{},[e]);A.useEffect(()=>(window.addEventListener("keydown",w),()=>{window.removeEventListener("keydown",w)}),[w]);const N=D=>{const E=new Date(D),C=W=>W.toString().padStart(2,"0");return`${C(E.getHours())}:${C(E.getMinutes())}`};return Ie.createPortal(a.jsx(ua,{onClick:k,children:a.jsxs(fa,{children:[a.jsx(pa,{onClick:e,children:a.jsx("svg",{width:"24",height:"24",children:a.jsx("use",{href:`${Y}#icon-close`})})}),a.jsx(ha,{children:"Add water"}),a.jsx(bt,{children:"Choose a value:"}),a.jsx(vt,{children:"Amount of water:"}),a.jsxs(va,{children:[a.jsx(yt,{onClick:S,children:a.jsx("svg",{width:"44",height:"44",children:a.jsx("use",{href:`${Y}#icon-minus`})})}),a.jsx(ba,{children:a.jsxs(wt,{children:[t,"ml"]})}),a.jsx(yt,{onClick:O,children:a.jsx("svg",{width:"44",height:"44",children:a.jsx("use",{href:`${Y}#icon-plus`})})})]}),a.jsx(vt,{children:"Recording time:"}),r?a.jsx(Ut,{onChange:g,value:d}):a.jsx(ma,{type:"text","aria-label":"Choose time",value:N(d),onChange:()=>{},onFocus:()=>o(!0)}),a.jsx(bt,{children:"Enter the value of the water used:"}),a.jsx(ga,{value:s,onBlur:P,onChange:V,type:"number"}),a.jsxs(ya,{children:[a.jsxs(wt,{children:[t,"ml"]}),a.jsx(xa,{onClick:y,type:"button",children:"Save"})]})]})}),document.getElementById("modal-root"))}const wa=f.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`,Na=f.p`
  ...
  line-height: 125%;
  color: #2f2f2f;
`;Ye.setAppElement("#root");function Ct({onClose:e}){const t=X(Wo),[n,r]=A.useState(t.amount),[o,s]=A.useState(!1),[l,i]=A.useState(0),d=re(),[u,h]=A.useState(t.date),{year:p,month:g}=Ne(),y=(E,C="")=>{let W=new Date(u);switch(C){case"hour":W.setHours(parseInt(E.target.value,10));break;case"minute":W.setMinutes(Math.ceil(parseInt(E.target.value,10)/5)*5);break}h(W)},O=()=>{d(cn({_id:t._id,amount:n,date:Date(u)})),d(xe({year:p,month:g})),e()},S=()=>{r(n+50),i(n+50)},P=()=>{if(n-50<0){r(0),i(0);return}r(n-50),i(n-50)},V=()=>{r(l)},k=E=>{const{value:C}=E.target;if(C==="")i("");else{let W=parseInt(C,10);W=isNaN(W)||W<0?0:W,i(W)}},w=E=>{E.target.closest("#selectTimeWrapper")||(s(!1),E.target===E.currentTarget&&e())},N=A.useCallback(()=>{},[e]);A.useEffect(()=>(window.addEventListener("keydown",N),()=>{window.removeEventListener("keydown",N)}),[N]);const D=E=>{const C=new Date(E),W=le=>le.toString().padStart(2,"0");return`${W(C.getHours())}:${W(C.getMinutes())}`};return Ie.createPortal(a.jsx(wa,{onClick:w,children:a.jsxs(Aa,{children:[a.jsx(Oa,{onClick:e,children:a.jsx("svg",{width:"24",height:"24",children:a.jsx("use",{href:`${Y}#icon-close`})})}),a.jsx(Ma,{children:"Edit the entered amount of water"}),a.jsxs(Da,{children:[" ",a.jsx("svg",{width:"36",height:"36",children:a.jsx("use",{href:`${Y}#icon-glass`})}),a.jsxs(Ta,{children:[t.amount,"ml"]}),a.jsx(Na,{children:D(t.date)})]}),a.jsx(At,{children:"Correct entered data:"}),a.jsx(Ot,{children:"Amount of water:"}),a.jsxs(ja,{children:[a.jsx(Mt,{onClick:P,children:a.jsx("svg",{width:"44",height:"44",children:a.jsx("use",{href:`${Y}#icon-minus`})})}),a.jsx(Ea,{children:a.jsxs(St,{children:[n,"ml"]})}),a.jsx(Mt,{onClick:S,children:a.jsx("svg",{width:"44",height:"44",children:a.jsx("use",{href:`${Y}#icon-plus`})})})]}),a.jsx(Ot,{children:"Recording time:"}),o?a.jsx(Ut,{onChange:y,value:u}):a.jsx(Sa,{type:"text","aria-label":"Choose time",value:D(u),onChange:()=>{},onFocus:()=>s(!0)}),a.jsx(At,{children:"Enter the value of the water used:"}),a.jsx(Ca,{value:l,onBlur:V,onChange:k,type:"number"}),a.jsxs(Pa,{children:[a.jsxs(St,{children:[n,"ml"]}),a.jsx(ka,{onClick:O,type:"button",children:"Save"})]})]})}),document.getElementById("modal-root"))}const Wa=f.div`
  padding: 0 24px 32px;
`,_a=f.div`
  display: flex;
  flex-direction: column;
...
`,Fa=f.p`
  ...
  margin-bottom: 24px;
`,Va=({onClose:e,isShow:t,id:n})=>{const r=re(),{year:o,month:s}=Ne();console.log("id в DeleteEntryModal який прийшов з пропсів",n);const l=i=>{console.log("id в DeleteEntryModal - handleDelete",i),r(dn(i)),r(xe({year:o,month:s})),r(Pt()),e()};return a.jsx(ln,{onClose:e,isShow:t,title:"Delete Entry",children:a.jsxs(Wa,{children:[a.jsx(Fa,{children:"Are you sure you want to delete the entry?"}),a.jsxs(_a,{children:[a.jsx(kt,{onClick:()=>l(n),children:"Delete"}),a.jsx(kt,{onClick:e,style:{color:"#407BFF"},children:"Cancel"})]})]})})},La=f.ul`
  overflow-y: scroll;
  height: 180px;
  display: flex;
  flex-direction: column;
...
`,$a=f.button`
  background-color: transparent;
`,Ua=()=>{const[e,t]=A.useState(!1),[n,r]=A.useState(!1),o=re(),[s,l]=A.useState(!1),i=X($e);console.log(i);const d=()=>{t(!1)},u=()=>{t(!0)},h=()=>{r(!1)},p=({amount:O,date:S,_id:P})=>{r(!0),o(un({amount:O,date:S,_id:P}))},g=()=>{l(!1)},y=()=>{l(!0)};return a.jsxs("div",{children:[a.jsxs("div",{children:[a.jsx(qa,{children:"Today"}),a.jsxs(La,{children:[i.length>0&&i.map(({_id:O,amount:S,date:P})=>a.jsx(a.Fragment,{children:a.jsxs(Ra,{children:[a.jsxs(Ha,{children:[a.jsx("img",{src:sa,alt:"Icon glass"}),a.jsxs(Ba,{children:[S," ml"]}),a.jsx(Ia,{children:Po(P)})]}),a.jsxs("div",{children:[a.jsx(Ya,{type:"button",onClick:()=>p({_id:O,amount:S,date:P}),children:a.jsx("img",{src:ca,alt:"Icon glass"})}),a.jsx($a,{type:"button",onClick:y,children:a.jsx("img",{src:la,alt:"Icon glass"})}),n&&a.jsx(Ct,{isOpen:n,onClose:h}),s&&a.jsx(Va,{isShow:s,onClose:g,id:O})]})]},O)})),n&&a.jsx(Ct,{isOpen:n,onClose:h})]})]}),a.jsxs(za,{type:"button",onClick:u,children:[a.jsx(ia,{})," Add Water"]}),e&&a.jsx(Xt,{isOpen:e,onClose:d})]})},Xa=Ua;function Ga(e){return $t({tag:"svg",attr:{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},child:[{tag:"circle",attr:{cx:"12",cy:"12",r:"10"},child:[]},{tag:"line",attr:{x1:"12",y1:"8",x2:"12",y2:"16"},child:[]},{tag:"line",attr:{x1:"8",y1:"12",x2:"16",y2:"12"},child:[]}]})(e)}const Qa=f.div`
  display: flex;
  justify-content: center;
  align-items: center;
  flex-direction: column;
...
`;function xi(){const e=re();return A.useEffect(()=>{e(Pt())},[e]),a.jsx(ui,{children:a.jsxs(pi,{children:[a.jsxs(fi,{children:[a.jsx(No,{}),a.jsx(ni,{})]}),a.jsxs(hi,{children:[a.jsx(Xa,{}),a.jsx(Jo,{})]})]})})}export{xi as default};
