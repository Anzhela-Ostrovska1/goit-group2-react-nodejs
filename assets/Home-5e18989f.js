import{n as f,r as w,p as Et,g as en,e as tn,f as nn,a as re,R as Be,j as a,N as Ue,h as rn,i as X,k as jt,s as Xe,b as on,l as Pe,L as an,m as Z,o as sn,q as cn,B as ln,t as dn,v as Pt,w as un}from"./index-63913c43.js";import{b as fn}from"./bg_element_des@1x-1805b66c.js";const pn=f.div`
  padding: 8px 20px;
...
`,Fa=f.p`
  ...
  margin-bottom: 24px;
`,Va=({onClose:e,isShow:t,id:n})=>{const r=re(),{year:o,month:s}=$e();console.log("id в DeleteEntryModal який прийшов з пропсів",n);const l=i=>{console.log("id в DeleteEntryModal - handleDelete",i),r(dn(i)),r(Pe({year:o,month:s})),r(Pt()),e()};return a.jsx(ln,{onClose:e,isShow:t,title:"Delete Entry",children:a.jsxs(Wa,{children:[a.jsx(Fa,{children:"Are you sure you want to delete the entry?"}),a.jsxs(_a,{children:[a.jsx(kt,{onClick:()=>l(n),children:"Delete"}),a.jsx(kt,{onClick:e,style:{color:"#407BFF"},children:"Cancel"})]})]})})},La=f.ul`
  overflow-y: scroll;
  height: 180px;
  display: flex;
  flex-direction: column;
