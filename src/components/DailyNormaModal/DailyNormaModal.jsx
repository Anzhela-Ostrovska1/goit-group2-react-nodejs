...
import { DailyNormaModalContainer, Wrapper } from './DailyNormaModal.styled.js'
...
const DailyNormaModal = ({onClose}) => {
  ...
  const handleSubmit = (evt) => {
    try {
      evt.preventDefault();
      if (waterRate < 2) return Notiflix.Notify.failure('The required amount of water in liters per day: 2L');
      if(waterRate >15) return Notiflix.Notify.failure('The maximum amount of water in liters per day: 15L')
